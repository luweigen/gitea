...
| `path-fit` | the "Fit…" entry beside "Align…" in the selection menu: where it sits, when it is offered, the geometry of its three fits, and that one undo takes the original stroke back |
